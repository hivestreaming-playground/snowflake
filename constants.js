...
export const tracks: Tracks = {
  "PRIVACY": {
    "displayName": "Privacy",
    "category": "A",
    "description": "The Privacy Officer is responsible for the organization's privacy program, including but not limited to the day-to-day operation of the program, development, implementation and maintenance of policies and procedures, monitoring of program compliance, investigation and tracking of incidents and breaches.",
    "milestones": [{
      "summary": "Basic understanding of privacy regulations and practices",
      "signals": [
        "Have an understanding of what GDPR and CCPA are and stand for",
        "Have an overall understanding of 'privacy by design'",
      ],
      "examples": [
        "Have completed the basic privacy training and understand Hive's privacy policy",
        "Add follow button for publications on AndroidResponded to employee questions regarding Hive's information security classification of documents",
      ],
    }, {
      "summary": "Privacy Champion",
      "signals": [
        "Demonstrate an interest and ability to learn more about privacy rules and best practices",
        "Internal privacy advocate",
      ],
      "examples": [
        "Has raised privacy issues with his team",
        "Conducted additional training/education on privacy protection",
      ],
    }, {
      "summary": "Well informed about privacy rules and principles",
      "signals": [
        "Be familiar with some of the key privacy laws, such as GDPR and CCPA",
        "Always think about privacy risks and designed privacy when working with data and people",
        "Think of personal data as the new oil, which must always be protected",
      ],
      "examples": [
        "Have handled many privacy-related projects internally with great success",
        "Has discussed privacy-related issues with clustomers and other stakeholders",
        "Has evaluated existing privacy frameworks",
        "Ensured that a project is compliant with our privacy framework",
      ],
    }, {
      "summary": "Fluent in privacy concepts and all privacy principles",
      "signals": [
        "Ability to speak to both engineers and business stakeholders about the importance of privacy laws and design principles",
        "Passionate about data protection and people's right to privacy",
        "Excellent writing skills",
      ],
      "examples": [
        "Led company-wide initiatives and projects that had a significant impact on the company",
        "Protected the company from risks and concerns related to privacy issues",
        "Created or contributed significantly to existing privacy policies",
      ],
    }, {
      "summary": "Expert in Privacy Regulations",
      "signals": [
        "Have an excellent understanding of the types of information the company holds",
        "Ability to negotiate skilfully and find acceptable compromises",
        "Senior privacy expert supporting all business units with privacy advice",
        "Possess a high degree of integrity and trust",
      ],
      "examples": [
        "Has built a strategic and comprehensive confidentiality program that minimizes risks and ensures the confidentiality of protected information, on paper and/or electronically, in all types of media",
        "Raised risks and concerns to senior management",
        "Been responsible for compliance with privacy regulations",
        "Conducted external and internal audits",
      ],
    }],
  },
  ...
  "INFO_SEC": {
    ...
    "category": "A",
    "description": "Information Security professionals work on the processes designed to protect sensitive business information from alteration, disruption, destruction and inspection. Spreading security awareness and building a good security culture for all employees is an important task",
    "milestones": [{
      "summary": "Information Security novice",
      "signals": [
        "Demonstrate basic knowledge of various information security and cybersecurity standards",
        "Have basic IT skills",
      ],
      "examples": [
        "Initiated simple standards for the organization",
        "Reviewed existing standard and commented on communication or transparency improvements",
        "Helped people with their basic information security questions",
      ],
    }, {
      "summary": "Security Champion",
      "signals": [
        "Understand the Hive culture to set new standards",
        "Have a continuous learning approach and a passion for information security",
        "Demonstrates the ability to find relevant information and standards for their daily work",
      ],
      "examples": [
        "Brought new security issues to the security team for investigation",
        "Created new information policy standards with little supervision",
        "Created new security initiatives and took steps to complete them",
      ],
    }, {
      "summary": "Information Security professional with broad domain expertise",
      "signals": [
        "Plans organizational security compliance programs and audits",
        "Demonstrates strong knowledge of standards such as NIST, ISO27001, CIS and COBIT",
      ],
      "examples": [
        "Has delivered and implemented data protection procedures and policies",
        "Created (or substantially contributed to) business continuity and incident management plans",
        "Implemented and followed up on EY audit requirements (NIST, ISO 270001, CIS, COBIT)",
        "Demonstrated knowledge of industry standards/certifications such as CISSP, CISM or similar",
      ],
    }, {
      "summary": "Expert Leader in Information Security",
      "signals": [
        "Has a strategic vision for the organization's information security program",
        "Wants to simplify the organization's information security challenges and complexities",
        "Demonstrates the ability to handle both external auditors and meet customers with confidence",
      ],
      "examples": [
        "Completed strategic information security projects and key initiatives over a period of one year (e.g. SOC2 or I27001)",
        "Owned and managed external audits and client related projects",
        "Evaluated the three lines of defense, C.I.A. and risk management in the organization",
      ],
    }, {
      "summary": "Strategic leader in Information Security",
      "signals": [
        "Know which cyber risks to prioritise, when and to whom",
        "Natural problem solver with a security mindset",
        "Builds and reinforces an Information Security culture in the company",
      ],
      "examples": [
        "Reported cybersecurity to senior management and to the Board as needed",
        "Worked with Senior Management on key security initiatives",
      ],
    }],
  },
  ...
  "IT_SEC": {
    ...
    "category": "A",
    "description": "IT security works on cybersecurity strategies that prevent unauthorized access to organizational assets such as computers, networks and data. This function maintains the integrity and confidentiality of sensitive information and blocks the access of sophisticated hackers.",
    "milestones": [{
      "summary": "Junior IT Security",
      "signals": [
        "Demonstrates basic networking, routing, switching, and vlans skills. Knowledge equivalent to CCNA Networking certification",
        "Has a basic understanding of how security works in macOs and Windows",
        "Actively works to ensure the security of company assets",
      ],
      "examples": [
        "Configured firewalls and (virtual) private networks in our network",
        "Monitored alerts and provided basic IT security support to our users",
        "Helped users install Intune and Sophos",
        "Upgraded firewall frameworks",
        "Configured a honeypot to monitor malicious activity",
      ],
    }, {
      "summary": "IT Sec",
      "signals": [
        "Happy to share his knowledge of IT security with ordinary users",
        "Demonstrates knowledge of security infrastructure, network threats and vulnerabilities, and threat mitigation (e.g. CCNA Security certification or similar certificate)",
        "Demonstrates a basic understanding of ethical hacking",
      ],
      "examples": [
        "Has managed firewalls and identified security risks",
        "Has created, updated and communicated security documentation",
        "Managed anti-virus software and EDR and established new policies",
        "Reduced vulnerabilities and threats in different environments",
        "Secured wireless environments",
      ],
    }, {
      "summary": "Senior IT Sec",
      "signals": [
        "Demonstrates knowledge of security standards such as NIST, ISO27001, SOC2",
        "Applies their knowledge of threat modelling in their daily work",
        "Demonstrates knowledge of Microsoft365 security, cybersecurity breach detection and effective security incident management. Knowledge equivalent to MS-500 certification and cyberops cisco (200-201 CBROPS)",
        "Have intermediate coding skills (e.g. PowerShell, Python, C++) and some automation experience",
        "Demonstrates in-depth knowledge of operating systems and hardening",
      ],
      "examples": [
        "Completed audits for standards such as NIST, ISO and SOC2",
        "Prepared security reports for senior management",
        "Implemented advanced configuration for Azure AD",
        "Implemented advanced configurations in Microsoft Intune or similar services",
        "Created custom plugins and security automation (e.g. CVE exploits)",
      ],
    }, {
      "summary": "Master IT Sec",
      "signals": [
        "Demonstrates strong skills in Microsoft/Azure Cloud security and has very good knowledge of authentication and access control (in areas covered by Az-500 and Cisco Certified CyberOps Professional Certification)",
        "Has effective communication with other teams in the company",
        "Assists in establishing new SOC2 and ISO27001 controls for audits",
      ],
      "examples": [
        "Facilitated and implemented comprehensive conditional access, identity management and privileged identity management across the enterprise",
        "Ensured access to across cloud environments using vendor recommendations, e.g. rights management in Azure",
        "Operated own security projects in the cloud and on-premises",
        "Conducted and managed vulnerability assessments, red team exercises and other security drills",
      ],
    }, {
      "summary": "Strategic leader in IT Security",
      "signals": [
        "Ability to lead strategic security initiatives across the organisation",
        "Have a good ability to balance security requirements against business requirements",
        "Owner of key business assets (related to IT security)",
      ],
      "examples": [
        "Managed several comprehensive security projects",
        "Established multi-year strategic security plans",
      ],
    }],
  },
  ...
  "BUSINESS_SOL": {
    ...
    "category": "A",
    "description": "Business Tech supports the delivery of essential technological benefits that can improve business efficiency and productivity and reduce costs. To be agile and accelerate digital innovation and transformation, low-code application development is an essential skill for this role.",
    "milestones": [{
      "summary": "Power User",
      "signals": [
        "Sees opportunities to automate basic tasks in a tool",
        "Demonstrates a willingness to acquire in-depth knowledge of key systems used by the company",
      ],
      "examples": [
        "Created a Jira automation and configure according to best practices",
        "Configured forms and layouts in Confluence and/or JSM",
        "Resolved out of disk errors independently",
      ],
    }, {
      "summary": "Power User with ambitions",
      "signals": [
        "Demonstrates a basic understanding of authentication and authorization",
        "Has the willingness to create simple API integrations between systems",
        "Demonstrates the ability to troubleshoot integrations between systems",
      ],
      "examples": [
        "Connected and created automation between Jira with PowerFlow",
        "Configured SSO for a third party system",
        "Acquired knowledge equivalent to a PL-900 certification.",
      ],
    }, {
      "summary": "Automation Specialist",
      "signals": [
        "Be confident in creating advanced API integration between multiple IT systems",
        "Demonstrate a good understanding of how key IT systems work",
      ],
      "examples": [
        "Connected Salesforce to Partner Center via Power Automate",
        "Implemented access management in integrations",
        "Built custom integration using Azure functions",
        "Acquired knowledge equivalent to a certification in PL-100 and PL-600",
        "Documented your solutions in Confluence so others can maintain and further develop them",
      ],
    }, {
      "summary": "Automation Guru",
      "signals": [
        "Have broad skills and capacity to build your own service and connect multiple systems",
        "Shows interest in the company's processes and sees opportunities to develop new automations to meet business needs",
      ],
      "examples": [
        "Created and maintained an automated billing system",
        "Developed and maintained a system for auditing access to IT systems",
      ],
    }, {
      "summary": "Automation Strategist",
      "signals": [
        "Demonstrate an excellent understanding of business processes and needs",
        "Planning new strategic tools for the business",
        "Demonstrates excellent communication skills",
      ],
      "examples": [
        "Developed new roadmaps and plans to simplify IT and business processes",
        "Found external suppliers who solved our business needs",
      ],
    }],
  },
  ...
  "PROD_SEC": {
    ...
    "category": "A",
    "description": "In the role of Product Security, you will work to ensure that all aspects of secure product development are considered, from requirements to post-launch. You will need to understand and manage the complexities of software development and its methodologies",
    "milestones": [{
      "summary": "Ethical Hacker",
      "signals": [
        "Demonstrates a practical understanding of ethical hacking (CEH)",
        "Has the ability to assess vulnerabilities and weaknesses",
        "Ability to develop automation",
      ],
      "examples": [
        "Has researched information about vulnerabilities from OWASP or other sources",
        "Tested various environments, networks and applications to detect vulnerabilities, misconfigurations and weaknesses",
        "Verified and communicated vulnerabilities (discovered by scanners or internally or through a bug bounty program) to the relevant teams",
        "Automated monotonous and repetitive tasks",
      ],
    }, {
      "summary": "Whitehat Hacker",
      "signals": [
        "Advocates shift-left security (secure by design)",
        "Demonstrates understanding of threat modelling and mitigation plans",
        "Demonstrates participation in security training in various areas",
      ],
      "examples": [
        "Implemented CI/CD security testing in our build environment",
        "Helped product teams create threat modelling and mitigation plans",
        "Trained product teams and developers to self-manage security related events",
      ],
    }, {
      "summary": "Professional Hacker",
      "signals": [
        "Demonstrates an understanding of advanced vulnerability analysis",
        "Seeks new ways to highlight security risks and improve our security posture",
      ],
      "examples": [
        "Identified and mitigated logical vulnerabilities and weaknesses",
        "Maintained and improved our SIEM and enabled behavioural analysis of production logs",
        "Enabled products to meet forensic analysis requirements",
        "Implemented and managed rights management and security in Azure",
        "Acquired practical knowledge of infrastructure protection (equivalent to AZ900 and AZ500)",
      ],
    }, {
      "summary": "Architect",
      "signals": [
        "Works to ensure security design in the operation and development of our products",
        "Demonstrates deep understanding of SSDLC and contributes to process improvement",
        "Manages internal and external security projects",
      ],
      "examples": [
        "Designed and implemented SSDLC in multiple teams and projects",
        "Enhanced SSDLC with existing technology and requirements in Hive",
        "Improved business continuity in projects and/or the company as a whole",
        "Contributed to Infrastructure as Code with security through design and automations",
        "Implemented a security project with the help of an external vendor",
      ],
    }, {
      "summary": "Chief Architect",
      "signals": [
        "Ensure that Hive's product security is the best on the market and meets customer and industry requirements",
        "Build customer and partner confidence in our security and product quality",
        "Manage all product security, from development requirements to operations, incident management, business continuity, sales, investors and auditors at all levels",
        "Challenges existing product security standards such as SSDLC, NIST and SOC2",
      ],
      "examples": [
        "Automated delivery of all product security requirements, documentation and communication to various audiences (e.g. development, product, sales, partners, customers, managers, boards and investors)",
        "Worked on improvements, research and development of what we do today, but did not follow traditional methods",
      ],
    }],
  },
  ...
  "IT_SUPPORT": {
    "displayName": "Internal IT Support & Administration",
    "category": "A",
    "description": "Internal IT support and administrators manage the organisation's overall IT systems and all devices used by employees. The role maintains overall information systems and networks at headquarters and performs troubleshooting",
    "milestones": [{
      "summary": "Junior Support",
      "signals": [
        "Communicates successfully with end users and identifies problems",
        "Basic understanding of the technology we use at the company, e.g. Windows, macOs, corporate networks) and the willingness to learn more",
        "Demonstrates an understanding of company structure and culture",
      ],
      "examples": [
        "Found a solution to the problem or found someone who can solve the problem and documented this in tickets",
        "Has managed users and groups in M365",
        "Installed a printer driver on the users machine",
        "Configured and/or reinstalled software to a resolve problem",
      ],
    }, {
      "summary": "Pre-senior Support",
      "signals": [
        "Good at solving problems and understanding the problem behind the failure",
        "Work independently to solve IT problems (Google-Fu and think outside the box)",
        "Knowledge equivalent to an MS-900 certification",
        "Basic ITIL understanding",
      ],
      "examples": [
        "Fixed Wifi problem in the office",
        "Contacted vendor support to resolve an issue",
        "Has troubleshot hardware and drivers",
        "Had a conversation with the manufacturer who replaced the motherboard",
        "Installed internal memory in a computer",
        "Administered M365 services such as Sharepoint, Streams, One-Drive and Intune",
      ],
    }, {
      "summary": "Senior Support",
      "signals": [
        "Identifies potential problems before they occur and takes preventive action",
        "Proficient at documenting problems in Confluence/JSM for future troubleshooting",
        "Understands the importance of keeping systems up to date",
        "Feels a responsibility to keep office equipment up and running",
      ],
      "examples": [
        "Created a script that automatically installs printer drivers",
        "Installed updates on the office network (e.g. Unifi) without breaking it",
        "Maintained our asset management",
        "Configured SSO to third party systems",
        "Documented IT-related processes and policies in Confluence",
      ],
    }, {
      "summary": "Lead IT Support",
      "signals": [
        "Willingly shares knowledge and writes complex instructions for problem solving",
        "Feels responsibility for the preparation and review for parts of the IT budget",
        "Demonstrates overall responsibility for the onboarding and offboarding process",
      ],
      "examples": [
        "Managed a number of key IT systems used by the business",
        "Identified duplicate IT service systems and decommissioned them",
        "Identified discrepancies in the access management process and resolved them",
        "Refined the ITIL process in the company",
        "Pointed a team member in the right direction so he/she can solve the problem on his/her own",
      ],
    }, {
      "summary": "Master IT Support",
      "signals": [
        "Have a good knowledge of the majority of all IT systems used at Hive",
        "Leads a team of support technicians",
        "Able to balance the IT budget against the needs of the business",
        "Strives to empower employees in their daily work as much as possible",
      ],
      "examples": [
        "Determined the total IT budget per year and followed it up",
        "Conducted an annual follow-up of employees' experience with internal IT",
      ],
    }],
  },
